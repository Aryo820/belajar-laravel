            ...
            <div class="card">
                ...
                <form id="transactionForm">
                    <div class="form-group">
                        <label for="customerSelect" class="form-label">Pelanggan</label>
                        {{-- Tambahkan id="customerSelect" pada tag select --}}
                        <select name="id_customer" id="customerSelect" class="form-control">
                            <option value="" data-phone="" data-address="">Pilih Pelanggan</option>
                            @foreach ($customers as $customer)
                                {{-- Tambahkan atribut data-phone dan data-address --}}
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            {{-- Pastikan input ini memiliki id="customerPhone" --}}
                            <input type="phone" id="customerPhone" required>
                        </div>
                        <div class="form-group">
                            <label for="customerAddress">Alamat</label>
                            {{-- Pastikan input ini memiliki id="customerAddress" --}}
